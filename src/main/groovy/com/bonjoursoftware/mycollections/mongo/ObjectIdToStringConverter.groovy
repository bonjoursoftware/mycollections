...
@Singleton
class ObjectIdToStringConverter implements Serializer<ObjectId> {
    @Override
    void serialize(Encoder encoder, EncoderContext context, Argument<? extends ObjectId> type, ObjectId value) throws IOException {
